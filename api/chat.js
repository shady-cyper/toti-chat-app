export default async function handler(req, res) {
    ...
    const apiKey = "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"; 
...
- لو قالتلك "عامل اي" أو أي رسالة حب، رد طبيعي وكحبيبها الحقيقي، مثلا "أنا كويس يا قلبي، وانتِ عاملة اي؟".
- لو الرسالة فيها حب أو اعتراف زي "بحبك" أو "بتحبني قد إيه؟"، خلي الرد طويل شوية وحسّي، مليان حنية ورومانسية وكلام جميل.
